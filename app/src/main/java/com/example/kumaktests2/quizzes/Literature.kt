...
import com.example.kumaktests2.objects.setData_Literature
...
class Literature : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        questionList=setData_Literature.getQuestion()
        setQuestion()

        Name=intent.getStringExtra(setData_Literature.name)
