...
import com.example.kumaktests2.objects.setData_History
...
class History : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        questionList=setData_History.getQuestion()
        setQuestion()

        Name=intent.getStringExtra(setData_History.name)
            ...
            if(selectedOption!=0){
                ...
                when{
                    currentPosition<=questionList!!.size->{
                        ...
                        intent.putExtra(setData_History.name, Name.toString())
                        intent.putExtra(setData_History.score, score.toString())
